...
namespace Platform.Infrastructure.Migrations
{
    ...
    [Migration("20260509151118_AddExportArtifactTargetScope")]
    partial class AddExportArtifactTargetScope
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("export_artifact", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_export_artifact_checksum_sha256", "checksum_sha256 ~ '^[0-9a-f]{64}$'");
                            ...
                            t.HasCheckConstraint("ck_export_artifact_status", "status IN ('succeeded')");
