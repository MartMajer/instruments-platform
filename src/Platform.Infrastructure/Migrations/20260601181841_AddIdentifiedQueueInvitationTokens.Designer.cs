...
namespace Platform.Infrastructure.Migrations
{
    ...
    [Migration("20260601181841_AddIdentifiedQueueInvitationTokens")]
    partial class AddIdentifiedQueueInvitationTokens
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("invitation_token", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_invitation_token_respondent_subject_shape", "(channel = 'identified_queue' AND respondent_subject_id IS NOT NULL) OR (channel <> 'identified_queue' AND respondent_subject_id IS NULL)");
                        });
                });
