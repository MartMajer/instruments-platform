            ...
            migrationBuilder.Sql(
                ...
                BEGIN
                    IF EXISTS (
                        ...
                        GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE email_template TO platform_app_runtime;
                    END IF;
                END
                $$;
                """);
            ...
            migrationBuilder.Sql(
                ...
                BEGIN
                    IF EXISTS (
                        ...
                        REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE email_template FROM platform_app_runtime;
                    END IF;
                END
                $$;
                """);
