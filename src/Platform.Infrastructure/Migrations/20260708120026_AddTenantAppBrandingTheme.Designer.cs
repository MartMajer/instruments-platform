...
namespace Platform.Infrastructure.Migrations
{
    ...
    [Migration("20260708120026_AddTenantAppBrandingTheme")]
    partial class AddTenantAppBrandingTheme
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Platform.Domain.Campaigns.EmailSuppression", b =>
                {
                    ...
                    b.HasIndex("TenantId", "Recipient", "CampaignSeriesId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Platform.Domain.Tenancy.Tenant", b =>
                {
                    ...
                    b.Property<string>("AppBrandingAccentColorHex")
                        .HasMaxLength(7)
                        .HasColumnType("character varying(7)")
                        .HasColumnName("app_branding_accent_color_hex");

                    b.Property<string>("AppBrandingBackgroundColorHex")
                        .HasMaxLength(7)
                        .HasColumnType("character varying(7)")
                        .HasColumnName("app_branding_background_color_hex");

                    b.Property<string>("AppBrandingInkColorHex")
                        .HasMaxLength(7)
                        .HasColumnType("character varying(7)")
                        .HasColumnName("app_branding_ink_color_hex");

                    b.Property<string>("AppBrandingLogoContentType")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("app_branding_logo_content_type");

                    b.Property<string>("AppBrandingLogoObjectKey")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                        .HasColumnName("app_branding_logo_object_key");

                    b.Property<string>("AppBrandingSurfaceColorHex")
                        .HasMaxLength(7)
                        .HasColumnType("character varying(7)")
                        .HasColumnName("app_branding_surface_color_hex");

                    b.Property<string>("AppBrandingTopbarColorHex")
                        .HasMaxLength(7)
                        .HasColumnType("character varying(7)")
                        .HasColumnName("app_branding_topbar_color_hex");

                    b.Property<DateTimeOffset?>("AppBrandingUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("app_branding_updated_at");

                    b.Property<Guid?>("AppBrandingUpdatedBy")
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("tenant", null, t =>
                        {
                            t.HasCheckConstraint("ck_tenant_app_branding_accent_color_hex", "app_branding_accent_color_hex IS NULL OR app_branding_accent_color_hex ~ '^#[0-9A-Fa-f]{6}$'");

                            t.HasCheckConstraint("ck_tenant_app_branding_background_color_hex", "app_branding_background_color_hex IS NULL OR app_branding_background_color_hex ~ '^#[0-9A-Fa-f]{6}$'");

                            t.HasCheckConstraint("ck_tenant_app_branding_ink_color_hex", "app_branding_ink_color_hex IS NULL OR app_branding_ink_color_hex ~ '^#[0-9A-Fa-f]{6}$'");

                            t.HasCheckConstraint("ck_tenant_app_branding_logo_content_type", "app_branding_logo_content_type IS NULL OR app_branding_logo_content_type IN ('image/png','image/jpeg','image/webp')");

                            t.HasCheckConstraint("ck_tenant_app_branding_surface_color_hex", "app_branding_surface_color_hex IS NULL OR app_branding_surface_color_hex ~ '^#[0-9A-Fa-f]{6}$'");

                            t.HasCheckConstraint("ck_tenant_app_branding_topbar_color_hex", "app_branding_topbar_color_hex IS NULL OR app_branding_topbar_color_hex ~ '^#[0-9A-Fa-f]{6}$'");
