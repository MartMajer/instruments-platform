...
namespace Platform.Infrastructure.Migrations
{
    ...
    [Migration("20260517141205_AddWithdrawalEvents")]
    partial class AddWithdrawalEvents
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("withdrawal_event", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_withdrawal_event_counts_non_negative", "consent_record_count >= 0 AND response_session_count >= 0 AND answer_count >= 0 AND score_count >= 0");
                            ...
                            t.HasCheckConstraint("ck_withdrawal_event_status", "status IN ('planned')");
