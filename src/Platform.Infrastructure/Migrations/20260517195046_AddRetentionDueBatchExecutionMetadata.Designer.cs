...
namespace Platform.Infrastructure.Migrations
{
    ...
    [Migration("20260517195046_AddRetentionDueBatchExecutionMetadata")]
    partial class AddRetentionDueBatchExecutionMetadata
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("withdrawal_event", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_withdrawal_event_status", "status IN ('planned', 'processing', 'completed', 'failed')");

                            t.HasCheckConstraint("ck_withdrawal_event_target_kind", "target_kind IN ('identified_subject', 'anonymous_longitudinal_code', 'anonymous_longitudinal_unmatched')");
