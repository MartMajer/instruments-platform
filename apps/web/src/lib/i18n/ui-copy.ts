...
const surfaceNavCopies: LocaleDictionary<SurfaceNavCopy> = {
	en: {
		...
		descriptions: {
			...
			buildStudy: 'Prepare study',
			collect: 'Run collection',
			reportsExports: 'Results and exports',
			compareWaves: 'Repeated rounds',
	...
	'hr-HR': {
		...
		descriptions: {
			...
			buildStudy: 'Pripremi studiju',
			collect: 'Provedi prikupljanje',
			reportsExports: 'Rezultati i izvoz',
			compareWaves: 'Ponovljeni krugovi',
