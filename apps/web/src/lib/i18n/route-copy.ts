...
const en = {
	...
	publicEntry: {
		...
		productStage: 'Clean exports',
		productStageRibbon: 'Download response datasets, data descriptions, and report packets for analysis.',
...
const hr: typeof en = {
	...
	publicEntry: {
		...
		productStage: 'Čist izvoz',
		productStageRibbon:'Preuzmite podatke odgovora, opis podataka i sažetke izvještaja za analizu.',
