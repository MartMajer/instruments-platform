...
const en = {
	...
	publicEntry: {
		...
		metaDescription:'Study operations for questionnaires, collection, results, longitudinal waves, and export-ready datasets in an EU-hosted workspace.',
		...
		productStage: 'EU data',
		productStageRibbon: 'Workspace onboarding and study data run in an EU-hosted environment.',
