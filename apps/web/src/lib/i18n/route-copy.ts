...
const en = {
	...
	settings: {
		...
		languageTitle: 'Study and respondent default',
		defaultLanguage: 'Default language',
		unsavedChanges: 'Unsaved changes',
		noChanges: 'No changes',
		saveLanguage: 'Save language',
		saving: 'Saving...',
		languageSaved: 'Default language saved.',
		languageSaveFailed: 'Language settings could not be saved.',
		emailKicker: 'Email',
		emailTitle: 'Invitation and reminder templates',
		templateTabsAria: 'Email template selection',
		customTemplate: 'Custom template',
		defaultTemplate: 'Built-in default',
		subject: 'Subject',
		bodyText: 'Body text',
		requiredVariables: 'Required variables',
		validationIssues: 'Template validation issues',
		preview: 'Preview',
		saveTemplate: 'Save template',
		resetTemplate: 'Reset to default',
		resetting: 'Resetting...',
		templateSaved: 'Email template saved.',
		templateReset: 'Email template reset.',
		templateSaveFailed: 'Email template could not be saved.',
		templateResetFailed: 'Email template could not be reset.',
		subjectRequired: 'Subject is required.',
		bodyTooShort: 'Body text must be at least 80 characters.',
		missingVariable: (variable: string) => `Body text must include ${variable}.`,
		htmlNotAllowed: 'Email templates are plain text and cannot contain HTML.',
		managementDestinations: 'Management destinations',
	...
	respondent: {
		...
		runnerSurveyQuestions: 'Survey questions',
		runnerProgress: 'Survey progress',
		runnerQuestion: 'Question',
		runnerOf: 'of',
		runnerLeft: 'left',
		runnerRequired: 'Required',
		runnerChooseAnswer: 'Choose an answer to continue.',
		runnerOnlyThis: 'Only this',
		runnerChooseUpTo: (count: number) => `Choose up to ${count} options in order.`,
		runnerAnswer: 'Answer',
		runnerAnswerWithUnit: (unit: string) => `Answer (${unit})`,
		runnerNoQuestionsAvailable: 'No questions available',
		targetContextAria: 'Response target',
		targetContextKicker: 'You are answering about',
		respondentContextKicker: 'Answering as',
		targetRoleLabel: 'Relationship',
		queueAria: 'Response queue',
		queueKicker: 'Response queue',
		queueProgress: (submitted: number, total: number) =>
			`${submitted} of ${total} ${total === 1 ? 'target' : 'targets'} submitted.`,
		queueConsentTitle: 'Before you start',
		queueAssignments: 'Assigned response targets',
		queueStart: (target: string) => `Start ${target}`,
		queueContinue: (target: string) => `Continue ${target}`,
		queueStarting: 'Starting...',
		queueNotStartedStatus: 'Not started',
		queueDraftStatus: 'In progress',
		queueSubmittedStatus: 'Submitted',
		queueAssignmentFallback: 'Assigned target',
		queueRespondentFallback: 'Respondent',
		...
		previewMetaFallback: 'Respondent preview',
		previewAria: 'Respondent preview',
		previewLoading: 'Loading respondent preview',
		previewUnavailableAria: 'Respondent preview unavailable',
		previewKicker: 'Respondent preview',
		previewUnavailableTitle: 'Preview unavailable',
		previewWrongSeries: 'This preview belongs to a different study.',
		previewExpired: 'This preview expired. Return to setup and open a fresh preview.',
		previewInvalid: 'This preview could not be read safely. Return to setup and open it again.',
		previewMissing: 'No preview draft was found. Return to setup and open Preview as respondent.',
		previewBackToSetup: 'Back to setup',
		previewTitle: (seriesName: string) => `${seriesName} respondent preview`,
		previewLocalOnlyBody: 'Preview answers stay in this browser and do not count in results.',
		previewCompleteKicker: 'Local preview',
		previewCompleteTitle: 'Preview complete',
		previewNoPersistence: 'No response session, answer row, score, or submission was created.',
		previewReturnToSetup: 'Return to setup',
		previewReviewKicker: 'Local review',
		previewReviewTitle: 'Preview review',
		previewAnsweredVisible: (answered: number, total: number) =>
			`${answered} of ${total} visible questions have answers. These answers are local only.`,
		previewBackToEdit: 'Back to edit',
		previewFinish: 'Finish preview',
		previewSaveStatusLocalOnly: 'Preview answers are local only.',
		previewSaveStatusReady: 'Preview answers are ready for local review.'
	},
	unsubscribe: {
	...
	selectedStudy: {
		...
		reportsWorkflow: {
			...
			component: {
				...
				exportChoicesAria: 'Export file choices',
				exportProfileAria: 'Reviewed export file profile',
				resultsMatrixUse:
					'Aggregate rows for score cards, result tables, group comparisons, and measurement comparisons.',
				responseDatasetUse:
					'Submitted-response rows for analysis handoff with the generated codebook.',
				...
				rowsLabel: 'Rows',
				rowShapeLabel: 'Row shape',
				columnsLabel: 'Columns',
				sampleColumnsLabel: 'Sample columns',
				readinessChecks: 'Export readiness checks',
				noSampleColumns: 'Review the export file to inspect columns.',
		...
		reportWidgets: {
			...
			labels: {
				...
				noFilteredRows: 'No rows match the current filters.',
...
const hr: typeof en = {
	...
	settings: {
		...
		workspaceControls: 'Kontrole radnog prostora',
		languageKicker: 'Jezik',
		languageTitle: 'Zadano za studije i sudionike',
		defaultLanguage: 'Zadani jezik',
		unsavedChanges: 'Nespremljene promjene',
		noChanges: 'Nema promjena',
		saveLanguage: 'Spremi jezik',
		saving: 'Spremanje...',
		languageSaved: 'Zadani jezik je spremljen.',
		languageSaveFailed: 'Postavke jezika nije bilo moguće spremiti.',
		emailKicker: 'E-pošta',
		emailTitle: 'Predlošci pozivnica i podsjetnika',
		templateTabsAria: 'Odabir predloška e-pošte',
		customTemplate: 'Prilagođeni predložak',
		defaultTemplate: 'Ugrađeni zadani predložak',
		subject: 'Naslov',
		bodyText: 'Tekst poruke',
		requiredVariables: 'Obavezne varijable',
		validationIssues: 'Problemi validacije predloška',
		preview: 'Pregled',
		saveTemplate: 'Spremi predložak',
		resetTemplate: 'Vrati zadano',
		resetting: 'Vraćanje...',
		templateSaved: 'Predložak e-pošte je spremljen.',
		templateReset: 'Predložak e-pošte je vraćen na zadano.',
		templateSaveFailed: 'Predložak e-pošte nije bilo moguće spremiti.',
		templateResetFailed: 'Predložak e-pošte nije bilo moguće vratiti.',
		subjectRequired: 'Naslov je obavezan.',
		bodyTooShort: 'Tekst poruke mora imati barem 80 znakova.',
		missingVariable: (variable: string) => `Tekst poruke mora sadržavati ${variable}.`,
		htmlNotAllowed: 'Predlošci e-pošte su običan tekst i ne smiju sadržavati HTML.',
		managementDestinations: 'Upravljačka odredišta',
	...
	respondent: {
		...
		runnerSurveyQuestions: 'Pitanja upitnika',
		runnerProgress: 'Napredak upitnika',
		runnerQuestion: 'Pitanje',
		runnerOf: 'od',
		runnerLeft: 'preostalo',
		runnerRequired: 'Obavezno',
		runnerChooseAnswer: 'Odaberite odgovor za nastavak.',
		runnerOnlyThis: 'Samo ovo',
		runnerChooseUpTo: (count: number) => `Odaberite do ${count} opcija redom.`,
		runnerAnswer: 'Odgovor',
		runnerAnswerWithUnit: (unit: string) => `Odgovor (${unit})`,
		runnerNoQuestionsAvailable: 'Nema dostupnih pitanja',
		targetContextAria: 'Cilj odgovora',
		targetContextKicker: 'Odgovarate o osobi',
		respondentContextKicker: 'Odgovarate kao',
		targetRoleLabel: 'Odnos',
		queueAria: 'Red odgovaranja',
		queueKicker: 'Red odgovaranja',
		queueProgress: (submitted: number, total: number) =>
			`${submitted} od ${total} ${total === 1 ? 'cilja predan' : 'ciljeva predano'}.`,
		queueConsentTitle: 'Prije početka',
		queueAssignments: 'Dodijeljeni ciljevi odgovaranja',
		queueStart: (target: string) => `Započni ${target}`,
		queueContinue: (target: string) => `Nastavi ${target}`,
		queueStarting: 'Pokretanje...',
		queueNotStartedStatus: 'Nije započeto',
		queueDraftStatus: 'U tijeku',
		queueSubmittedStatus: 'Predano',
		queueAssignmentFallback: 'Dodijeljeni cilj',
		queueRespondentFallback: 'Sudionik',
		...
		previewMetaFallback: 'Pregled za sudionika',
		previewAria: 'Pregled za sudionika',
		previewLoading: 'Učitavanje pregleda za sudionika',
		previewUnavailableAria: 'Pregled za sudionika nije dostupan',
		previewKicker: 'Pregled za sudionika',
		previewUnavailableTitle: 'Pregled nije dostupan',
		previewWrongSeries: 'Ovaj pregled pripada drugoj studiji.',
		previewExpired: 'Ovaj pregled je istekao. Vratite se na postavljanje i otvorite novi pregled.',
		previewInvalid:
			'Ovaj pregled nije bilo moguće sigurno pročitati. Vratite se na postavljanje i otvorite ga ponovno.',
		previewMissing:
			'Nacrt pregleda nije pronađen. Vratite se na postavljanje i otvorite Pregled kao sudionik.',
		previewBackToSetup: 'Natrag na postavljanje',
		previewTitle: (seriesName: string) => `${seriesName} pregled za sudionika`,
		previewLocalOnlyBody: 'Odgovori pregleda ostaju u ovom pregledniku i ne ulaze u rezultate.',
		previewCompleteKicker: 'Lokalni pregled',
		previewCompleteTitle: 'Pregled dovršen',
		previewNoPersistence: 'Nije izrađena sesija odgovaranja, redak odgovora, rezultat ni predaja.',
		previewReturnToSetup: 'Vrati se na postavljanje',
		previewReviewKicker: 'Lokalni pregled',
		previewReviewTitle: 'Pregled odgovora',
		previewAnsweredVisible: (answered: number, total: number) =>
			`${answered} od ${total} vidljivih pitanja ima odgovore. Ti su odgovori samo lokalni.`,
		previewBackToEdit: 'Natrag na uređivanje',
		previewFinish: 'Završi pregled',
		previewSaveStatusLocalOnly: 'Odgovori pregleda samo su lokalni.',
		previewSaveStatusReady: 'Odgovori pregleda spremni su za lokalni pregled.'
	},
	unsubscribe: {
	...
	selectedStudy: {
		...
		reportsWorkflow: {
			...
			surface: {
				...
				title: 'Radna površina rezultata',
				description:
					'Pregledajte sigurne kartice rezultata, usporedite grupe i mjerenja te izradite kontrolirane CSV izvoze kada su spremni.',
			...
			component: {
				...
				exportChoicesAria: 'Odabir datoteke izvoza',
				exportProfileAria: 'Profil pregledane datoteke izvoza',
				resultsMatrixUse:
					'Agregirani redci za kartice rezultata, tablice rezultata, usporedbe grupa i usporedbe mjerenja.',
				responseDatasetUse: 'Redci predanih odgovora za analizu uz generirani opis podataka.',
				...
				resultsPreview: 'Radna površina rezultata',
				...
				rowsLabel: 'Redci',
				rowShapeLabel: 'Oblik redaka',
				columnsLabel: 'Stupci',
				sampleColumnsLabel: 'Primjeri stupaca',
				readinessChecks: 'Provjere spremnosti izvoza',
				noSampleColumns: 'Pregledajte datoteku izvoza za provjeru stupaca.',
		...
		reportWidgets: {
			...
			labels: {
				...
				interpretationCockpit: 'Kokpit rezultata',
				attentionSignals: 'Signali za pažnju',
				resultProfile: 'Profil rezultata',
				profileRadar: 'Radarski profil',
				profileScale: 'Ljestvica profila',
				lowerRange: 'niže',
				higherRange: 'više',
				excludedFromProfile: 'Izvan profila',
				profileUnavailable: 'Za profil su potrebna barem tri kompatibilna vidljiva rezultata.',
				groupHeatmap: 'Toplinska mapa grupa',
				whereItHappens: 'Gdje se događa',
				heatmapUnavailable: 'Toplinska mapa grupa nije dostupna',
				currentTrend: 'Trenutno kretanje',
				latestResult: 'Zadnji rezultat',
				visibleResultOutputs: 'Vidljivi rezultati',
				hiddenOutputs: 'Skriveni rezultati',
				resultFocus: 'Fokus rezultata',
				allResultOutputs: 'Svi izlazi rezultata',
				allGroups: 'Sve grupe',
				allMeasurements: 'Sva mjerenja',
				resultsFilters: 'Filtri rezultata',
				filteredRows: 'Filtrirani redci',
				scoreCards: 'Kartice rezultata',
				...
				noFilteredRows: 'Nema redaka za trenutačne filtre.',
				...
				resultsPreviewWidgets: 'Kartice radne površine rezultata',
				resultsSummary: 'Sažetak rezultata',
				resultsDetailTabs: 'Odjeljci detalja rezultata',
				rows: 'Redci',
			...
			codeLabels: {
				...
				stable: 'stabilno',
				unavailable: 'nedostupno',
				difference_range: 'rezultat razlike',
				score_range_missing: 'nedostaje usporediv raspon rezultata',
				not_numeric: 'nije numerički',
