...
const en = {
	...
	publicEntry: {
		...
		showcaseExports: 'Evidence',
		showcaseResults: 'Field',
		showcaseCollect: 'Protocol',
	...
	workspaceHome: {
		...
		startBody:
			'Most teams begin by creating a study, adding people, then launching collection after preparation is ready.',
		...
		firstRunActionDescriptions: [
			'Start a real study and continue through preparation, collection, and results.',
		...
		sampleDemo: {
			...
			description:
				'See complete synthetic studies with preparation, collection, results, and export context before creating your own.',
			status: 'Sample data',
	...
	portfolio: {
		...
		studyModelStudyBody:
			'The durable study container for preparation, collection rounds, results, and export files.',
	...
	directory: {
		...
		howUsed: 'How people data is used',
		...
		graphConnectionAria: 'Microsoft people import',
		graphConnectionKicker: 'People import',
		graphConnectionTitle: 'Import from Microsoft',
		graphConnectionBody:
			'Use Microsoft Graph to bring people, groups, memberships, and manager links into People. After import, launch, respondent entry, and reports use platform records instead of live Microsoft reads.',
		graphConnectionActionNext:
			'Prepare tenant-scoped admin consent for this people import. Microsoft redirects back to People when consent completes.',
		graphConnect: 'Prepare admin consent',
		graphReconnect: 'Prepare reconnect consent',
		graphRetryConsent: 'Prepare new consent request',
		graphConsentPreparing: 'Preparing consent...',
		graphConsentPreparedTitle: 'Consent request prepared',
		graphConsentPreparedMessage:
			'The request is stored with hashed state and nonce. Continue with Microsoft admin consent once live redirect wiring is available.',
		graphConsentExpires: 'Request expires',
		graphConsentCallbackPath: 'Callback path',
		graphConsentOpenMicrosoft: 'Open Microsoft admin consent',
		graphConsentFailed: 'Could not prepare Microsoft Graph consent.',
		graphImportRunsAria: 'Microsoft people import runs',
		graphImportRunsTitle: 'Recent Microsoft people imports',
		graphImportRunsBody:
			'Recent preview and apply runs are shown with safe counts only. Raw Microsoft payloads and identifiers stay out of this view.',
		graphImportRunsRecovery:
			'Runs linked to an active saved import rule can be previewed again by fetching a fresh Microsoft Graph people snapshot. Evidence-only runs cannot be replayed.',
		graphImportRunRows: 'Imported rows',
		graphImportRunWarnings: 'Warning categories',
		graphImportRunCompleted: 'Completed',
		graphImportRunRerunLive: 'Preview this rule again',
		graphImportRunRerunUnavailable: 'This Microsoft import is not linked to an active saved rule.',
		graphImportRulesAria: 'Microsoft people import rules',
		graphImportRulesTitle: 'Saved Microsoft import rules',
		graphImportRulesBody:
			'Save a tenant-scoped people population rule before replay controls are enabled. Rules store only source kind, population, stale policy, and allowed field names.',
		graphImportRulesEmptyTitle: 'No saved Microsoft import rules',
		graphImportRulesEmptyMessage:
			'Create a rule to make future preview, apply, and retry flows reference a durable people population definition.',
		graphImportRuleName: 'Rule name',
		graphImportRuleNameRequired: 'Enter a Microsoft import rule name.',
		graphImportRuleMarkMissing: 'Mark missing Microsoft users stale during apply',
		graphImportRuleSave: 'Save import rule',
		graphImportRuleSaving: 'Saving rule...',
		graphImportRuleSaveFailed: 'Could not save Microsoft import rule.',
		graphImportRuleArchive: 'Archive rule',
		graphImportRuleArchiveFailed: 'Could not archive Microsoft Graph import rule.',
		graphImportRulePreviewLive: 'Preview Microsoft import',
		graphImportRuleApplyLive: 'Apply Microsoft import',
		graphImportRulePreviewFailed: 'Could not preview Microsoft import rule.',
		graphImportRuleApplyFailed: 'Could not apply Microsoft import rule.',
		graphImportRulePreviewRequired: 'Preview this Microsoft import rule before applying it.',
		graphImportRulePreviewReady: 'Microsoft import preview ready',
		graphImportRulePreviewRows: 'Preview rows',
		graphImportRulePreviewWarnings: 'Adapter warnings',
		graphImportRuleStalePolicy: 'Stale policy',
		graphImportRuleRetainedFields: 'Retained fields',
		graphImportRuleUpdated: 'Updated',
		graphImportRuleMarkStale: 'Mark stale',
		graphImportRuleNoStale: 'Do not mark stale',
		graphImportRulesRunNext:
			'Preview or retry from a saved rule still needs live connector input that can fetch a fresh Microsoft Graph people snapshot.',
		graphStatus: 'Status',
		graphWorkspace: 'Workspace',
		graphGrantedScopes: 'Granted permissions',
		graphNoGrantedScopes: 'No Microsoft permissions granted yet',
		graphLastConsent: 'Last consent',
		graphLastImport: 'Last import',
		graphStatusActive: 'Connected',
		graphStatusPendingConsent: 'Consent pending',
		graphStatusConsentRequired: 'Consent required',
		graphStatusRevoked: 'Consent revoked',
		graphStatusFailed: 'Connection failed',
		graphStatusDisconnected: 'Not connected',
		...
		fixFailedRows: 'Fix the failed rows before applying this People import.',
		applyingImport: 'Applying the reviewed People import...',
		checkingRows: 'Checking rows without changing People records...',
		...
		managerLinksToSet: 'Manager links to set',
		managerLinksSet: 'Manager links set',
		managerLinksAlreadyCurrent: 'Manager links already current',
		managerLinksNeedingAttention: 'Manager links needing attention',
		peopleMarkedStale: 'People marked stale',
		peopleReturnedFromStale: 'People returned from stale',
		previewOnlyTitle: 'Preview only',
		previewOnlyMessage:
			'Nothing has been saved yet. Review the actions below, then apply the import.',
		allRowsAccepted: 'All imported rows were accepted.',
		importActions: 'Import actions',
		peopleDirectoryAria: 'People directory',
		directoryGraphCounts: 'People graph counts',
		refresh: 'Refresh',
		email: 'Email',
		roleInGroup: 'Role in group',
		directoryRelationshipsAria: 'People relationships',
		...
		loadFailed: 'People and groups could not be loaded.',
		...
		staleImportMarkedAt: (value: string) => `Last marked stale ${value}`,
		staleImportTitle: 'Marked stale by the latest directory import',
		...
		row: 'Row',
		loadingDirectory: 'Loading people and groups',
		unavailableTitle: 'People and groups unavailable',
		retryDirectory: 'Retry people',
		createRecordsAria: 'Create people records',
		creating: 'Creating...',
	...
	settings: {
		...
		studySetup: 'Study preparation',
		studySetupBody: 'Create or continue studies, questionnaires, collection rounds, and result outputs.',
		exportsBody: 'Review generated export files and download analysis-ready outputs.',
		workspaceDetails: 'Workspace details',
		profile: 'Workspace profile',
		scale: 'Workspace scale',
		footprint: 'Current footprint',
		directoryShortcut: 'People',
		...
		reportBrandingAria: 'Report branding preview',
		reportBrandingFormAria: 'Report branding settings',
		reportBrandingSave: 'Save report branding',
		reportBrandingSaving: 'Saving report branding...',
		reportBrandingSaved: 'Report branding saved',
		reportBrandingReset: 'Reset changes',
		reportBrandingSaveError: 'Report branding could not be saved',
		layoutStandard: 'Standard',
		layoutCompact: 'Compact',
		layoutCompliance: 'Compliance'
	},
	respondent: {
	...
	selectedStudy: {
		overview: {
			...
			title: 'Overview',
			description:
				'See where this study stands, then continue preparation, collection, results, or round comparison.',
		...
		surfaces: {
			...
			waves: {
				...
				ariaLabel: 'Rounds and linked repeat responses'
			}
		},
		setupBody: {
		...
		operationsBody: {
			...
			readiness: {
				...
				blocking: 'Blocking',
				warning: 'Warning',
				openSetup: 'Open Prepare',
				returnAndCheck: 'Return here and run the check again after saving setup.',
				blockedTitle: 'Preparation is blocked',
				blockedBody:
					'The check did not return itemized blockers. Open Prepare, review incomplete steps, save changes, then run this check again.',
			...
			component: {
				...
				readinessGuidance: {
					...
					useDraftWaveDetail:
						'This wave is no longer draft or scheduled. Open Prepare, select or create a draft collection wave, then run this check again.',
					chooseResponseModeTitle: 'Choose the response mode',
					chooseResponseModeDetail:
						'Open Prepare and save the Collection setup step with a valid response mode before starting collection.',
					connectQuestionnaireTitle: 'Connect the questionnaire to this wave',
					connectQuestionnaireDetail:
						'Open Prepare, save the Questionnaire step, then save the Collection setup step so the wave uses that questionnaire.',
					finishQuestionnaireTitle: 'Finish the questionnaire',
					finishQuestionnaireDetail:
						'Open Prepare and add at least one questionnaire section and question before starting collection.',
					finishResultsTitle: 'Finish result outputs',
					finishResultsDetail:
						'Open Prepare and save result outputs so reports know which answers become scores.',
					completePoliciesTitle: 'Complete study policies',
					completePoliciesDetail:
						'Open Prepare and save the consent, retention, and disclosure policies for this study before launch.',
					switchResponseModeTitle: 'Switch response mode',
					switchResponseModeDetail:
						'Saved specific-email lists are available for anonymous or repeat-participation waves. Open Prepare and change the response mode, or remove the saved recipient list.',
					...
					selectRecipientDetail:
						'Open Prepare and save at least one recipient selection that resolves to active people.',
					...
					fixAudienceDetail:
						'Open Prepare and adjust the recipient selection until the preview finds the people you expect.',
					reviewInstrumentTitle: 'Review the instrument',
					reviewInstrumentDetail:
						'Open Prepare and save the Instrument and Questionnaire steps again so this wave uses a launchable study instrument.',
			...
			disabled: {
				createWaveBeforeReadiness: 'Create a collection wave in preparation before checking readiness.',
				createWaveBeforeStart: 'Create a collection wave before starting collection.',
				...
				runPrelaunchAndSetup: 'Finish preparation before starting collection.',
			...
			status: {
				...
				noRecipientAccessDetail: 'Choose recipients or create respondent access after preparation is ready.',
				...
				createWaveFirstNextAction: 'Open Prepare and create a collection wave.',
				closedTitle: 'Closed',
				...
				draftDetail: 'Start collection when preparation is ready.',
		...
		reportsWorkflow: {
			...
			component: {
				...
				errors: {
					...
					createWaveBeforeReportPdf: 'Create or select a wave before creating a report PDF.',
					createDownloadableReportPdfBeforeSignedLink:
						'Create a downloadable report PDF before requesting a secure link.',
					retryReportPdfUnavailable: 'Retry is available only for failed report PDF artifacts.',
				...
				finishSetupFirst: 'Finish preparation first',
				...
				reportPdfResult: 'Report PDF result',
				reportPdf: 'Report PDF',
				reportPdfArtifact: 'Report PDF artifact',
				createReportPdf: 'Create report PDF',
				getSecurePdfLink: 'Get secure PDF link',
				securePdfLinkReady: 'Secure PDF link ready',
				openSecurePdfLink: 'Open secure PDF link',
				securePdfLinkExpires: 'Link expires',
				retryReportPdf: 'Retry report PDF',
			...
			stepNumber: (number: number) => `Step ${number}`,
			surface: {
				reviewActionsAria: 'Measurement comparison workflow',
				flowKicker: 'Study flow · Measurements',
				title: 'Compare repeated measurements',
				description:
					'Create follow-up waves from Setup, collect responses from Collection, then compare closed waves here.',
				scoreMethodLabel: 'Score method',
				scoreMethodReviewAria: 'Measurement score method review'
			},
			plan: {
			...
			component: {
				...
				measurementsTimelineAria: 'Measurement timeline',
				detailsDrawerTitle: 'Details: readiness, linking, scoring, and disclosure',
				wavePlanAria: 'Measurement plan',
				whereWavesFit: 'Where measurements fit',
				waveComparisonPlanAria: 'Measurement comparison plan',
				comparisonPlan: 'Comparison plan',
				groupTrendAria: 'Group trend review',
				groupTrend: 'Group trend',
				firstWave: 'First measurement',
				firstWaveResponses: 'First measurement responses',
				secondWave: 'Second measurement',
				secondWaveResponses: 'Second measurement responses',
				missing: 'Missing',
				wavesPathAria: 'Measurement comparison path',
				currentTaskAria: 'Current measurement task',
				taskProgress: (completed: number, total: number) =>
					`${completed} of ${total} comparison tasks done`,
				currentTaskTitle: 'Current comparison task',
				selectedSeries: 'Selected series',
				repeatedWaves: 'Repeated measurements',
				...
				launchedWaves: (count: number) => `${count} launched measurements`,
				wavesWithResponses: (count: number) => `${count} measurements with responses`,
				...
				waveAria: (name: string) => `Measurement ${name}`,
				responseMode: 'Response mode',
				submittedResponses: 'Submitted responses',
				waveComparisonPreviewAria: 'Measurement comparison preview',
				waveComparison: 'Measurement comparison',
				disclosureGatedComparison: 'Disclosure-gated comparison',
				disclosureK: (kMin: number) => `Disclosure k=${kMin}`,
				waveComparisonScoresAria: 'Measurement comparison scores',
				waveComparisonScoreAria: (dimensionCode: string) =>
					`Measurement comparison ${dimensionCode}`,
				...
				setUpNextWave: 'Set up next measurement',
...
const hr: typeof en = {
	...
	publicEntry: {
		...
		showcaseExports: 'Nalazi',
		showcaseResults: 'Teren',
		showcaseCollect: 'Protokol',
	...
	directory: {
		...
		howUsed: 'Kako se koriste podaci o ljudima',
		csvImport: 'CSV uvoz',
		...
		graphConnectionAria: 'Microsoft uvoz ljudi',
		graphConnectionKicker: 'Uvoz ljudi',
		graphConnectionTitle: 'Uvoz iz Microsofta',
		graphConnectionBody:
			'Koristite Microsoft Graph za uvoz ljudi, grupa, članstava i managerskih veza u Ljude. Nakon uvoza pokretanje studije, ulaz sudionika i izvještaji koriste platformske zapise umjesto live Microsoft čitanja.',
		graphConnectionActionNext:
			'Pripremite tenant-scoped administratorski pristanak za ovaj uvoz ljudi. Microsoft se vraća u Ljude nakon dovršetka pristanka.',
		graphConnect: 'Pripremi administratorski pristanak',
		graphReconnect: 'Pripremi ponovni pristanak',
		graphRetryConsent: 'Pripremi novi zahtjev za pristanak',
		graphConsentPreparing: 'Priprema pristanka...',
		graphConsentPreparedTitle: 'Zahtjev za pristanak je pripremljen',
		graphConsentPreparedMessage:
			'Zahtjev je spremljen s hashiranim state i nonce vrijednostima. Nastavite s Microsoft administratorskim pristankom kada bude dostupno live preusmjeravanje.',
		graphConsentExpires: 'Zahtjev istječe',
		graphConsentCallbackPath: 'Callback putanja',
		graphConsentOpenMicrosoft: 'Otvori Microsoft administratorski pristanak',
		graphConsentFailed: 'Nije moguće pripremiti Microsoft Graph pristanak.',
		graphImportRunsAria: 'Microsoft uvozni zapisi ljudi',
		graphImportRunsTitle: 'Nedavni Microsoft uvozi ljudi',
		graphImportRunsBody:
			'Nedavni pregledi i primjene prikazani su samo sa sigurnim brojevima. Sirovi Microsoft payloadi i identifikatori nisu u ovom prikazu.',
		graphImportRunsRecovery:
			'Ponovno pokretanje je dostupno za pokretanja povezana s aktivnim spremljenim pravilom uvoza dohvatom svježe Microsoft Graph snimke ljudi. Pokretanja samo za evidenciju ne mogu se ponoviti.',
		graphImportRunRows: 'Uvezeni redci',
		graphImportRunWarnings: 'Kategorije upozorenja',
		graphImportRunCompleted: 'Dovršeno',
		graphImportRunRerunLive: 'Ponovno pregledaj ovo pravilo',
		graphImportRunRerunUnavailable: 'Ovaj Microsoft uvoz nije povezan s aktivnim spremljenim pravilom.',
		graphImportRulesAria: 'Microsoft pravila uvoza ljudi',
		graphImportRulesTitle: 'Spremljena Microsoft pravila uvoza',
		graphImportRulesBody:
			'Spremite tenant-scoped pravilo populacije ljudi prije omogućavanja ponovnog pokretanja. Pravila spremaju samo vrstu izvora, populaciju, stale politiku i dopuštena imena polja.',
		graphImportRulesEmptyTitle: 'Nema spremljenih Microsoft pravila uvoza',
		graphImportRulesEmptyMessage:
			'Izradite pravilo kako bi budući pregled, primjena i ponovno pokretanje koristili trajnu definiciju populacije.',
		graphImportRuleName: 'Naziv pravila',
		graphImportRuleNameRequired: 'Unesite naziv Microsoft pravila uvoza.',
		graphImportRuleMarkMissing: 'Označi nedostajuće Microsoft korisnike zastarjelima tijekom primjene',
		graphImportRuleSave: 'Spremi pravilo uvoza',
		graphImportRuleSaving: 'Spremanje pravila...',
		graphImportRuleSaveFailed: 'Nije moguće spremiti Microsoft pravilo uvoza.',
		graphImportRuleArchive: 'Arhiviraj pravilo',
		graphImportRuleArchiveFailed: 'Nije moguće arhivirati Microsoft Graph pravilo uvoza.',
		graphImportRulePreviewLive: 'Pregledaj Microsoft uvoz',
		graphImportRuleApplyLive: 'Primijeni Microsoft uvoz',
		graphImportRulePreviewFailed: 'Nije moguće pregledati Microsoft pravilo uvoza.',
		graphImportRuleApplyFailed: 'Nije moguće primijeniti Microsoft pravilo uvoza.',
		graphImportRulePreviewRequired: 'Pregledajte ovo Microsoft pravilo uvoza prije primjene.',
		graphImportRulePreviewReady: 'Microsoft pregled uvoza spreman',
		graphImportRulePreviewRows: 'Retci pregleda',
		graphImportRulePreviewWarnings: 'Upozorenja adaptera',
		graphImportRuleStalePolicy: 'Stale politika',
		graphImportRuleRetainedFields: 'Zadržana polja',
		graphImportRuleUpdated: 'Ažurirano',
		graphImportRuleMarkStale: 'Označi zastarjelim',
		graphImportRuleNoStale: 'Ne označavaj zastarjelim',
		graphImportRulesRunNext:
			'Pregled ili ponavljanje iz spremljenog pravila još treba live konektor koji može dohvatiti svježu Microsoft Graph snimku ljudi.',
		graphStatus: 'Status',
		graphWorkspace: 'Radni prostor',
		graphGrantedScopes: 'Odobrene dozvole',
		graphNoGrantedScopes: 'Još nema odobrenih Microsoft dozvola',
		graphLastConsent: 'Zadnji pristanak',
		graphLastImport: 'Zadnji uvoz',
		graphStatusActive: 'Povezano',
		graphStatusPendingConsent: 'Pristanak na čekanju',
		graphStatusConsentRequired: 'Potreban je pristanak',
		graphStatusRevoked: 'Pristanak opozvan',
		graphStatusFailed: 'Veza nije uspjela',
		graphStatusDisconnected: 'Nije povezano',
		...
		fixFailedRows: 'Popravite neuspjele retke prije primjene ovog uvoza ljudi.',
		applyingImport: 'Primjenjujem pregledani uvoz ljudi...',
		checkingRows: 'Provjeravam retke bez promjene zapisa ljudi...',
		...
		managerLinksToSet: 'Managerske veze za postavljanje',
		managerLinksSet: 'Managerske veze postavljene',
		managerLinksAlreadyCurrent: 'Managerske veze već su ažurne',
		managerLinksNeedingAttention: 'Managerske veze koje traže pažnju',
		peopleMarkedStale: 'Ljudi označeni kao zastarjeli',
		peopleReturnedFromStale: 'Ljudi vraćeni iz zastarjelog stanja',
		previewOnlyTitle: 'Samo pregled',
		previewOnlyMessage:
			'Još ništa nije spremljeno. Pregledajte radnje u nastavku, zatim primijenite uvoz.',
		allRowsAccepted: 'Svi uvezeni retci su prihvaćeni.',
		importActions: 'Radnje uvoza',
		peopleDirectoryAria: 'Ljudi',
		directoryGraphCounts: 'Brojevi ljudi',
		refresh: 'Osvježi',
		email: 'E-pošta',
		roleInGroup: 'Uloga u grupi',
		directoryRelationshipsAria: 'Odnosi ljudi',
		...
		loadFailed: 'Ljudi i grupe nisu se mogli učitati.',
		...
		staleImport: 'Zastarjelo u uvozu',
		staleImportMarkedAt: (value: string) => `Označeno kao zastarjelo ${value}`,
		staleImportTitle: 'Označeno kao zastarjelo u zadnjem uvozu imenika',
		notAvailable: 'Nije dostupno',
		unmatchedRow: 'Nepovezan redak',
		previewed: 'Pregledano',
		imported: 'Uvezeno',
		importRunId: 'Uvozni zapis',
		row: 'Redak',
		loadingDirectory: 'Učitavanje ljudi i grupa',
		unavailableTitle: 'Ljudi i grupe nisu dostupni',
		retryDirectory: 'Pokušaj ponovno',
		createRecordsAria: 'Izrada zapisa ljudi',
		creating: 'Izrada...',
	...
	settings: {
		...
		reportBrandingAria: 'Pregled brendiranja izvještaja',
		reportBrandingFormAria: 'Postavke brendiranja izvještaja',
		reportBrandingSave: 'Spremi brendiranje izvještaja',
		reportBrandingSaving: 'Spremanje brendiranja izvještaja...',
		reportBrandingSaved: 'Brendiranje izvještaja je spremljeno',
		reportBrandingReset: 'Poništi promjene',
		reportBrandingSaveError: 'Brendiranje izvještaja nije moguće spremiti',
		layoutStandard: 'Standardno',
		layoutCompact: 'Kompaktno',
		layoutCompliance: 'Usklađenost'
	},
	respondent: {
	...
	selectedStudy: {
		...
		setupWorkflow: {
			...
			designMap: {
				...
				questionnaireSaved: (name: string, questionCount: number) =>
					`${name} objavljen je za pokretanje s ${questionCount} ${questionCount === 1 ? 'pitanjem' : 'pitanja'}.`,
		...
		reportsWorkflow: {
			...
			component: {
				...
				errors: {
					...
					createWaveBeforeReportPdf:
						'Izradite ili odaberite mjerenje prije izrade PDF izvještaja.',
					createDownloadableReportPdfBeforeSignedLink:
						'Izradite PDF izvještaj dostupan za preuzimanje prije zahtjeva za sigurnom poveznicom.',
					retryReportPdfUnavailable:
						'Ponovni pokušaj dostupan je samo za neuspjele artefakte PDF izvještaja.',
				...
				reportPdfResult: 'Rezultat PDF izvještaja',
				reportPdf: 'PDF izvještaj',
				reportPdfArtifact: 'Artefakt PDF izvještaja',
				createReportPdf: 'Izradi PDF izvještaj',
				getSecurePdfLink: 'Dohvati sigurnu PDF poveznicu',
				securePdfLinkReady: 'Sigurna PDF poveznica spremna',
				openSecurePdfLink: 'Otvori sigurnu PDF poveznicu',
				securePdfLinkExpires: 'Poveznica istječe',
				retryReportPdf: 'Ponovi PDF izvještaj',
			...
			component: {
				...
				measurementsTimelineAria: 'Vremenska crta mjerenja',
				detailsDrawerTitle: 'Detalji: spremnost, povezivanje, bodovanje i pravila prikaza',
		...
		reportWidgets: {
			...
			labels: {
				...
				bestUse: 'Najbolja namjena',
				exportUseGuide: 'Koji izvoz koristiti?',
				exportUseGuideDescription:
					'Koristite agregirane izvoze za pregled, usporedbu grupa i usporedbu mjerenja. Skup odgovora koristite samo kada trebate analizu po pojedinačnim redcima.',
				dashboardMatrixExport: 'Izvoz pregleda i matrice',
				dashboardMatrixExportGuidance:
				...
				resultBarChart: 'Graf rezultata',
				groupBarChart: 'Graf usporedbe grupa',
				measurementTrendChart: 'Graf kretanja kroz mjerenja',
				dashboardNotes: 'Napomene pregleda',
				measurement: 'Mjerenje',
				observedRange: 'Prikazani raspon',
				selectedMeasurement: 'Odabrano mjerenje',
				selectedChartItem: 'Odabrana stavka',
				chartScale: 'Vrh skale',
				chartDataTable: 'Tablica podataka grafa',
				metric_visible_outputs: 'Vidljivi izlazi rezultata',
				metric_hidden_outputs: 'Skriveni izlazi',
				metric_group_rows: 'Vidljivi redci grupa',
				metric_compared_measurements: 'Uspoređena mjerenja',
				insights: 'Na što obratiti pažnju',
				evidenceSource: 'Izvor nalaza',
				currentSignal: 'Trenutni signal',
				whereToInspect: 'Gdje provjeriti',
				inspectResultMatrix: 'Provjerite tablicu izlaza rezultata',
				inspectGroupMatrix: 'Provjerite tablicu usporedbe grupa',
				inspectWaveMatrix: 'Provjerite tablicu usporedbe mjerenja',
				inspectMatrix: 'Provjerite tablice rezultata',
				change: 'Promjena',
				...
				noResultBars: 'Nema vidljivih vrijednosti za graf rezultata.',
				noGroupBars: 'Graf usporedbe grupa još nije dostupan.',
				noWaveTrendPoints: 'Graf kretanja kroz mjerenja još nije dostupan.',
				ready: 'Spremno',
				...
				resultsDashboardDataUnavailable: 'Podaci za pregled rezultata nisu dostupni.'
			},
			codeLabels: {
				proof_only: 'pregled',
				not_validated_interpretation: 'tumačenje nije validirano',
