...
const en = {
	...
	publicEntry: {
		...
		metaDescription:
			'EU-hosted study operations for questionnaires, collection, scoring, reports, longitudinal waves, and export-ready datasets.',
		...
		heroKicker: 'EU-hosted study operations',
		heroTitle: 'Run research and wellbeing studies without rebuilding the data stack.',
		heroBody:
			'Design serious questionnaires, collect the right response mode, review scoring context, compare waves, and export datasets with codebooks without stitching together forms, spreadsheets, scripts, and screenshots.',
		previewAria: 'Product preview',
		previewChrome: 'study operations',
		...
		prepareBody: 'Questionnaire, scoring plan, audience, consent, and launch checks stay visible before launch.',
		export: 'Export',
		...
		workflowRibbon: 'Questionnaire design, collection, scoring, reports, waves, and exports',
		access: 'Study access',
		...
		productStageRibbon: 'EU-hosted app path with staged workspace onboarding',
		workspaceOverview: 'Study command center',
		suiteTitle: 'Know what each study needs next.',
		suiteBody:
			'Keep preparation gaps, live collection, result review, wave comparison, and export readiness visible in one place.',
		nextAction: 'Next action',
		nextActionQuestion: 'What needs attention now?',
		appAreas: 'Work areas',
		studyStatus: 'Study status',
		workflowTitle: 'From study design to reusable evidence.',
		portfolio: 'Portfolio',
		portfolioBody: 'Create and return to active study programs, including repeated-wave programs.',
...
const hr: typeof en = {
	...
	publicEntry: {
		...
		previewChrome: 'operacije studije',
		previewCollect: 'Prikupljanje',
		previewResults: 'Rezultati',
		selectedStudy: 'Odabrana studija',
		previewStudyName: 'Puls opterećenja i oporavka',
		liveCollection: 'Prikupljanje u tijeku',
		responseSignal: 'Signal prikupljanja',
		responseProgress: '412 odgovora · 33% dovršeno',
		prepare: 'Priprema',
		launchChecklist: 'Kontrolna lista pokretanja',
		prepareBody: 'Upitnik, plan bodovanja, publika, privola i provjere pokretanja ostaju vidljivi prije pokretanja.',
		export: 'Izvoz',
		datasetCodebook: 'Skup podataka + šifrarnik',
		exportBody: 'Izvozi zajedno nose oblik skupa podataka, metapodatke šifrarnika, konačnost i izvorni kontekst.',
		trustAria: 'Kontrole studije',
		workflowRibbon: 'Dizajn upitnika, prikupljanje, bodovanje, izvještaji, valovi i izvozi',
		...
		suiteBody:
			'Držite praznine u pripremi, aktivno prikupljanje, pregled rezultata, usporedbu valova i spremnost izvoza na jednom mjestu.',
		nextAction: 'Sljedeća radnja',
		nextActionQuestion: 'Što sada traži pažnju?',
		appAreas: 'Radna područja',
		studyStatus: 'Status studije',
		workflowTitle: 'Od dizajna studije do ponovno upotrebljivih dokaza.',
		portfolio: 'Portfelj',
		portfolioBody: 'Izradite i nastavite aktivne programe studija, uključujući programe s ponovljenim valovima.',
