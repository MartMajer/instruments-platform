		...
		reportsWorkflow: {
			...
			translations: {
				...
				'Scored results are visible for internal review. Keep score meaning and method notes with any exported analysis.':
					'Izracunati rezultati vidljivi su za interni pregled. Uz svaku izvezenu analizu zadr�ite znacenje rezultata i bilje�ke o metodi.',
				...
				'Use this CSV and codebook for analysis. Keep method and interpretation notes with the file.':
					'Ovaj CSV i knjigu kodova koristite za analizu. Uz datoteku zadr�ite bilje�ke o metodi i tumacenju.',
				...
				'Use these results inside the workspace while export, interpretation, or collection status still needs review.':
					'Ove rezultate koristite unutar radnog prostora dok izvoz, tumacenje ili status prikupljanja jo� trebaju pregled.',
				...
				'All submitted responses have successful scoring activity.':
					'Svi predani odgovori imaju uspje�no izracunane rezultate.',
				...
				'Results can show output rows and missingness, but question-to-output coverage, reverse scoring, and answer scale family still need the Setup scoring plan. Do not infer better/worse meaning from output codes alone.':
					'Rezultati mogu prikazati izlazne retke i nedostajuce vrijednosti, ali pokrivenost pitanja, obrnuto bodovanje i vrsta ljestvice jo� trebaju plan rezultata iz Postavki. Nemojte zakljucivati bolje/lo�ije znacenje samo iz kodova izlaza.',
				...
				'Select a wave before deciding how results can be used.':
					'Odaberite mjerenje prije odluke o kori�tenju rezultata.',
				'No result data yet': 'Jo� nema podataka rezultata',
				'Collect responses before using or exporting results.':
					'Prikupite odgovore prije kori�tenja ili izvoza rezultata.',
				...
				'Do not present scored results yet. Use raw responses internally or fix scoring, missing-answer rules, and disclosure.':
					'Jo� nemojte predstavljati izracunate rezultate. Sirove odgovore koristite interno ili popravite bodovanje, pravila nedostajucih odgovora i pravila prikaza.',
				...
				'Response dataset, visible scores, reviewed interpretation, and closed collection are in place. Keep disclosure and study-method notes with anything shared.':
					'Skup odgovora, vidljivi rezultati, pregledano tumacenje i zatvoreno prikupljanje su spremni. Uz sve �to dijelite zadr�ite pravila prikaza i bilje�ke o metodi studije.'
			}
		},		wavesWorkflow: {
			stepNumber: (number: number) => `${number}`,
			plan: {
