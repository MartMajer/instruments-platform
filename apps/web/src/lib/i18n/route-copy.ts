	...
	selectedStudy: {
		...
		reportsWorkflow: {
			...
			translations: {
				...
				"Raw submitted responses exist. They can be exported for internal analysis when an export file is created.": "Postoje predani odgovori. Mogu se izvesti za internu analizu nakon izrade datoteke izvoza.",
				"Scored results are visible for internal review. Keep score meaning and method notes with any exported analysis.": "Izračunati rezultati vidljivi su za interni pregled. Uz svaku izvezenu analizu zadržite značenje rezultata i bilješke o metodi.",
				"Response dataset ready": "Skup odgovora je spreman",
				"Use this CSV and codebook for analysis. Keep method and interpretation notes with the file.": "Ovaj CSV i knjigu kodova koristite za analizu. Uz datoteku zadržite bilješke o metodi i tumačenju.",
				"Internal review only": "Samo interni pregled",
				"Use these results inside the workspace while export, interpretation, or collection status still needs review.": "Ove rezultate koristite unutar radnog prostora dok izvoz, tumačenje ili status prikupljanja još trebaju pregled.",
				...
				"Use Review results to load the score output rows. Results does not infer score meaning from hidden setup data.": "Upotrijebite Pregled rezultata za učitavanje redaka izlaza rezultata. Sustav ne zaključuje značenje rezultata iz skrivenih postavki.",
				"Response coverage": "Pokrivenost odgovora",
				"All submitted responses have successful scoring activity.": "Svi predani odgovori imaju uspješno izračunane rezultate.",
				"Direction and scale": "Smjer i ljestvica",
				"Direction and scale family need setup context": "Smjer i vrsta ljestvice trebaju kontekst iz postavki",
				"Results can show output rows and missingness, but question-to-output coverage, reverse scoring, and answer scale family still need the Setup scoring plan. Do not infer better/worse meaning from output codes alone.": "Rezultati mogu prikazati izlazne retke i nedostajuće vrijednosti, ali pokrivenost pitanja, obrnuto bodovanje i vrsta ljestvice još trebaju plan rezultata iz Postavki. Nemojte zaključivati bolje/lošije značenje samo iz kodova izlaza.",
				"Missing answers": "Nedostajući odgovori",
				"Missing-answer metadata available after reviewing results": "Metapodaci o nedostajućim odgovorima dostupni su nakon pregleda rezultata",
				"Use Review results to load valid/expected answer contribution counts where available.": "Upotrijebite Pregled rezultata za učitavanje broja važećih i očekivanih doprinosa odgovora gdje su dostupni.",
				"Interpretation boundary": "Granica tumačenja",
				"Custom-study interpretation, not externally validated": "Tumačenje prilagođene studije, bez vanjske validacije",
				"Use these scores as tenant-defined custom-study calculations. Do not present them as official norms, benchmarks, clinical thresholds, or externally validated claims.": "Ove rezultate koristite kao izračune prilagođene studije ovog radnog prostora. Nemojte ih predstavljati kao službene norme, usporedne vrijednosti, kliničke pragove ili vanjski validirane tvrdnje.",
				"No wave selected": "Nije odabrano mjerenje",
				"Select a wave before deciding how results can be used.": "Odaberite mjerenje prije odluke o korištenju rezultata.",
				"No result data yet": "Još nema podataka rezultata",
				"Collect responses before using or exporting results.": "Prikupite odgovore prije korištenja ili izvoza rezultata.",
				"Raw responses only": "Samo sirovi odgovori",
				"Do not present scored results yet. Use raw responses internally or fix scoring, missing-answer rules, and disclosure.": "Još nemojte predstavljati izračunate rezultate. Sirove odgovore koristite interno ili popravite bodovanje, pravila nedostajućih odgovora i pravila prikaza.",
				"Ready for controlled sharing": "Spremno za kontrolirano dijeljenje",
				"Response dataset, visible scores, reviewed interpretation, and closed collection are in place. Keep disclosure and study-method notes with anything shared.": "Skup odgovora, vidljivi rezultati, pregledano tumačenje i zatvoreno prikupljanje su spremni. Uz sve što dijelite zadržite pravila prikaza i bilješke o metodi studije.",
				"File purpose": "Namjena datoteke",
				"Row shape": "Oblik redaka",
				"Wave fields": "Polja mjerenja",
				"Trajectory keys": "Ključevi praćenja",
				"Variables and values": "Varijable i vrijednosti",
				"Missingness": "Nedostajuće vrijednosti",
				"Review export file to inspect contents": "Pregledajte datoteku izvoza za provjeru sadržaja",
				"Row shape available after file review": "Oblik redaka dostupan je nakon pregleda datoteke",
				"Wave fields available after file review": "Polja mjerenja dostupna su nakon pregleda datoteke",
				"Trajectory key policy available after file review": "Pravila ključeva praćenja dostupna su nakon pregleda datoteke",
				"Variables and values available after file review": "Varijable i vrijednosti dostupne su nakon pregleda datoteke",
				"Missingness policy available after file review": "Pravila nedostajućih vrijednosti dostupna su nakon pregleda datoteke",
				"Score outputs available after file review": "Izlazi rezultata dostupni su nakon pregleda datoteke",
				"Response dataset CSV and codebook": "CSV skup odgovora i knjiga kodova",
				"Use this for row-level analysis. Keep method, disclosure, and interpretation notes with the file.": "Koristite ovo za analizu na razini redaka. Uz datoteku zadržite bilješke o metodi, pravilima prikaza i tumačenju.",
				"Report-summary CSV, not row-level response data": "CSV sažetka izvještaja, ne podaci odgovora po retku",
				"Use this for internal aggregate review. Create a response dataset when you need submitted-response rows.": "Koristite ovo za interni agregirani pregled. Izradite skup odgovora kada trebate retke predanih odgovora.",
				"Review this file type before using it outside the workspace.": "Pregledajte ovu vrstu datoteke prije korištenja izvan radnog prostora.",
				"Each row represents one submitted response session in this study export.": "Svaki redak predstavlja jednu predanu sesiju odgovora u ovom izvozu studije.",
				"Each row summarizes one score output for the selected wave, not one respondent.": "Svaki redak sažima jedan izlaz rezultata za odabrano mjerenje, a ne jednog ispitanika.",
				"Review the codebook before interpreting row meaning.": "Pregledajte knjigu kodova prije tumačenja značenja redaka.",
				"Wave fields included": "Polja mjerenja su uključena",
				"Selected-wave lifecycle fields included": "Uključena su polja životnog ciklusa odabranog mjerenja",
				"The report-summary file describes the selected wave and its finality, not every wave in the study.": "Datoteka sažetka izvještaja opisuje odabrano mjerenje i njegovu finalnost, ne svako mjerenje u studiji.",
				"Wave fields not detected": "Polja mjerenja nisu otkrivena",
				"Review the codebook column list before using wave-level grouping.": "Pregledajte popis stupaca u knjizi kodova prije grupiranja po mjerenju.",
				"No trajectory keys in report-summary export": "Nema ključeva praćenja u izvozu sažetka izvještaja",
				"Report-summary exports are aggregate files and do not include respondent trajectory rows.": "Izvozi sažetka izvještaja su agregirane datoteke i ne uključuju retke praćenja ispitanika.",
				"Artifact-local trajectory keys included": "Uključeni su lokalni ključevi praćenja za ovu datoteku",
				"No trajectory key column detected": "Stupac ključa praćenja nije otkriven",
				"No trajectory keys": "Nema ključeva praćenja",
				"Use trajectory fields only when anonymous longitudinal linking is present and disclosure allows it.": "Polja praćenja koristite samo kada postoji anonimno longitudinalno povezivanje i kada pravila prikaza to dopuštaju.",
				"Question columns include codebook metadata such as question type, missing codes, scale anchors, value labels and answer constraints when available.": "Stupci pitanja uključuju metapodatke knjige kodova kao što su vrsta pitanja, kodovi nedostajućih vrijednosti, sidrišta ljestvice, oznake vrijednosti i ograničenja odgovora kada su dostupni.",
				"Columns describe aggregate score output, disclosure, finality, score metadata, and tenant-defined interpretation fields.": "Stupci opisuju agregirani izlaz rezultata, pravila prikaza, finalnost, metapodatke rezultata i polja tumačenja definirana u radnom prostoru.",
				"Review the codebook before using column values.": "Pregledajte knjigu kodova prije korištenja vrijednosti stupaca.",
				"Missing-answer codes documented": "Kodovi nedostajućih odgovora su dokumentirani",
				"Missing-answer codes not detected": "Kodovi nedostajućih odgovora nisu otkriveni",
				"Use the codebook missing-treatment fields and question missing codes before treating blanks as real answers.": "Prije tretiranja praznih vrijednosti kao stvarnih odgovora koristite polja postupanja s nedostajućim vrijednostima i kodove nedostajućih odgovora iz knjige kodova.",
				"Score missingness fields included": "Uključena su polja nedostajućih vrijednosti rezultata",
				"Score missingness fields not detected": "Polja nedostajućih vrijednosti rezultata nisu otkrivena",
				"Report-summary missingness describes valid/expected score contributions, not respondent-level skipped answers.": "Nedostajuće vrijednosti u sažetku izvještaja opisuju važeće/očekivane doprinose rezultatu, a ne preskočene odgovore na razini ispitanika.",
				"Missingness fields included": "Uključena su polja nedostajućih vrijednosti",
				"Missingness fields not detected": "Polja nedostajućih vrijednosti nisu otkrivena",
				"Review missingness fields before analysis.": "Pregledajte polja nedostajućih vrijednosti prije analize.",
				"No score metadata columns detected": "Nisu otkriveni stupci metapodataka rezultata",
				"Response datasets include score metadata fields when scores exist; keep score method notes with analysis.": "Skupovi odgovora uključuju metapodatke rezultata kada rezultati postoje; uz analizu zadržite bilješke o metodi rezultata.",
				"Score outputs listed in dimension_code": "Izlazi rezultata navedeni su u dimension_code",
				"Score output column not detected": "Stupac izlaza rezultata nije otkriven",
				"Use dimension_code with score_count and disclosure fields to understand aggregate score rows.": "Koristite dimension_code sa score_count i poljima prikaza za razumijevanje agregiranih redaka rezultata.",
				"Score outputs not detected": "Izlazi rezultata nisu otkriveni",
				"Review score output fields before interpretation.": "Pregledajte polja izlaza rezultata prije tumačenja."
			}
