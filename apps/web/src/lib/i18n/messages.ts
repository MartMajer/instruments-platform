...
const enMessages = {
	...
	'exports.library.context.campaignSeries': (values) =>
		`Studies / ${textValue(values, 'label')}`,
	...
	'readModel.row.campaigns': 'Measurements',
	'readModel.row.liveCampaigns': 'Live measurements',
	...
	'settings.metric.studies': 'Studies',
	'settings.metric.campaigns': 'Measurements',
	'settings.metric.liveCampaigns': 'Live measurements',
	...
	'settings.reportBranding.defaultReportTitle': 'Study report',
	...
	'workspace.lifecycle.prepare.label': 'Protocol',
	'workspace.lifecycle.prepare.description': 'Compose the instrument, questions, scoring, and launch rules.',
	'workspace.lifecycle.collect.label': 'Field',
	'workspace.lifecycle.collect.description': 'Launch the wave and watch responses and coverage build.',
	'workspace.lifecycle.review.label': 'Evidence',
	'workspace.lifecycle.review.description': 'Read compiled findings, limitations, and comparisons.',
	...
	'briefing.command.create.title': 'Create your first study',
	'briefing.command.create.description': 'Start with a study - the protocol will guide you to launch.',
	'briefing.command.create.action': 'Open Studies',
	'briefing.command.create.emptyTitle': 'No studies yet',
	'briefing.command.create.emptyDescription': 'This workspace has no active studies yet.',
	'briefing.command.create.emptyAction': 'View Studies',
	'briefing.command.directory.title': 'Set up People',
	'briefing.command.directory.description': 'Add people and groups before launch rules depend on them.',
	'briefing.command.directory.action': 'Open People',
	'briefing.command.protocol.title': (values) => `Finish the protocol for ${textValue(values, 'name')}`,
	'briefing.command.protocol.description': 'Protocol chapters still need work before launch.',
	'briefing.command.protocol.action': 'Open Protocol',
	'briefing.command.field.title': (values) => `Watch the field for ${textValue(values, 'name')}`,
	'briefing.command.field.description': 'Collection is running - watch responses and coverage build.',
	'briefing.command.field.action': 'Open Field',
	'briefing.command.evidence.title': (values) => `Read evidence for ${textValue(values, 'name')}`,
	'briefing.command.evidence.description': 'Submitted responses are ready to read.',
	'briefing.command.evidence.action': 'Open Evidence',
	'briefing.command.scoring.title': (values) => `Complete scoring for ${textValue(values, 'name')}`,
	'briefing.command.scoring.description': 'Scoring setup needs attention before evidence can compile.',
	'briefing.command.scoring.action': 'Open Protocol',
	'briefing.command.exports.title': (values) => `Inspect exports for ${textValue(values, 'name')}`,
	'briefing.command.exports.description': 'Export files are available from the Evidence surface.',
	'briefing.command.exports.action': 'Open exports',
	'briefing.command.rounds.title': (values) => `Compare rounds for ${textValue(values, 'name')}`,
	'briefing.command.rounds.description': 'At least two linked rounds are ready to compare.',
	'briefing.command.rounds.action': 'Open Rounds',
	'briefing.command.team.title': 'Review pending team access',
	'briefing.command.team.description': 'Some members still need an identity-provider link.',
	'briefing.command.team.action': 'Open Team',
	'briefing.command.review.title': 'Review your studies',
	'briefing.command.review.description': 'See totals and recent activity across the workspace.',
	'briefing.command.review.action': 'Open Studies',
	...
	'workspace.surface.campaignSeries': 'Studies',
	...
	'portfolio.row.campaigns': 'Measurements',
	'portfolio.row.liveCampaigns': 'Live measurements',
...
const hrMessages: AppMessageCatalog = {
	...
	'workspace.lifecycle.prepare.label': 'Protokol',
	'workspace.lifecycle.prepare.description': 'Postavite upitnik, pitanja, rezultate i pravila pokretanja.',
	'workspace.lifecycle.collect.label': 'Teren',
	'workspace.lifecycle.collect.description': 'Pokrenite mjerenje i pratite odgovore i pokrivenost.',
	'workspace.lifecycle.review.label': 'Nalazi',
	...
	'briefing.command.create.title': 'Izradite prvu studiju',
	'briefing.command.create.description': 'Počnite sa studijom - protokol vas vodi do pokretanja.',
	'briefing.command.create.action': 'Otvori Studije',
	'briefing.command.create.emptyTitle': 'Još nema studija',
	'briefing.command.create.emptyDescription': 'Ovaj radni prostor još nema aktivnih studija.',
	'briefing.command.create.emptyAction': 'Pogledaj Studije',
	'briefing.command.directory.title': 'Postavite Ljude',
	'briefing.command.directory.description': 'Dodajte osobe i grupe prije nego što pravila pokretanja ovise o njima.',
	'briefing.command.directory.action': 'Otvori Ljude',
	'briefing.command.protocol.title': (values) => `Dovršite protokol za ${textValue(values, 'name')}`,
	'briefing.command.protocol.description': 'Poglavlja protokola trebaju doradu prije pokretanja.',
	'briefing.command.protocol.action': 'Otvori Protokol',
	'briefing.command.field.title': (values) => `Pratite teren za ${textValue(values, 'name')}`,
	'briefing.command.field.description': 'Prikupljanje je u tijeku - pratite odgovore i pokrivenost.',
	'briefing.command.field.action': 'Otvori Teren',
	'briefing.command.evidence.title': (values) => `Pregledajte nalaze za ${textValue(values, 'name')}`,
	'briefing.command.evidence.description': 'Predani odgovori spremni su za pregled.',
	'briefing.command.evidence.action': 'Otvori Nalaze',
	'briefing.command.scoring.title': (values) => `Dovršite bodovanje za ${textValue(values, 'name')}`,
	'briefing.command.scoring.description': 'Postavke bodovanja trebaju pažnju prije sastavljanja nalaza.',
	'briefing.command.scoring.action': 'Otvori Protokol',
	'briefing.command.exports.title': (values) => `Pregledajte izvoze za ${textValue(values, 'name')}`,
	'briefing.command.exports.description': 'Datoteke izvoza dostupne su s površine Nalazi.',
	'briefing.command.exports.action': 'Otvori izvoze',
	'briefing.command.rounds.title': (values) => `Usporedite krugove za ${textValue(values, 'name')}`,
	'briefing.command.rounds.description': 'Najmanje dva povezana kruga spremna su za usporedbu.',
	'briefing.command.rounds.action': 'Otvori Krugove',
	'briefing.command.team.title': 'Pregledajte pristup tima na čekanju',
	'briefing.command.team.description': 'Neki članovi još trebaju poveznicu s pružateljem identiteta.',
	'briefing.command.team.action': 'Otvori Tim',
	'briefing.command.review.title': 'Pregledajte svoje studije',
	'briefing.command.review.description': 'Pogledajte ukupne brojke i nedavnu aktivnost radnog prostora.',
	'briefing.command.review.action': 'Otvori Studije',
