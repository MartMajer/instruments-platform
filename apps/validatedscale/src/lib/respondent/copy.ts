...
export const respondentCopy = {
	en: {
		...
		unsubscribeConfirm: 'Stop emails for this study',
		unsubscribeDone: 'You will not receive further emails for this study. Other studies from this workspace may still contact you.',
		unsubscribeWorkspace: 'Stop all emails from this workspace instead',
		unsubscribeDoneWorkspace: 'You will not receive further study emails from this workspace.',
	...
	hr: {
		...
		unsubscribeConfirm: 'Prestani slati e-poštu za ovo istraživanje',
		unsubscribeDone: 'Nećete više primati e-poštu za ovo istraživanje. Druga istraživanja ovog radnog prostora i dalje vas mogu kontaktirati.',
		unsubscribeWorkspace: 'Umjesto toga zaustavi svu e-poštu iz ovog radnog prostora',
		unsubscribeDoneWorkspace: 'Nećete više primati e-poštu istraživanja iz ovog radnog prostora.',
