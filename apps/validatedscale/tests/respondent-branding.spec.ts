...
const API = process.env.PUBLIC_API_BASE_URL ?? 'http://localhost:5055';
const DEV_TENANT = '11111111-1111-4111-8111-111111111111';
const devHeaders = {
...
async function brandTenant(request: APIRequestContext, accentColorHex: string) {
